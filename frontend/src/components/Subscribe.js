...
export default function Subscribe() {
  ...
  const subscribe = () => {
    fetch(
      ...
      .then((res) => res.json())
      .then((res) => {
        if (res === "You have now subscribed to औषध-Setu.") {
          notifyB(res);
          navigate("/home");
        } else if (
          res ===
          "Insufficient credits. Please earn or add credits to subscribe to औषध-Setu."
        ) {
          notifyA(res);
        } else {
          notifyA("Error");
            ...
            <div className="subs">
              ...
              <div className="headsub">
                ...
                <h2>
                  ...
                  worth <br /> <div id="orangec">1000 औषध-Setu Credits </div>{" "}
                </h2>
              </div>
              <button
                className="subbut"
